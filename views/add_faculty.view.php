<form class="w-50 mx-auto" method="POST" action="<?= $_SERVER['PHP_SELF'] ?>">
    ...
    <div class="form-group">
        ...
        <input type="text" name="qualification" value="<?= $data['qualification'] ?? ''?>" class="form-control" id="qualification" aria-describedby="qualificationHelp">
        <small class="text-danger"><?= $data['qualificationError'] ?? '' ?></small>
    </div>
    <div class="form-group">
